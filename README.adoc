...
you probably hit https://issues.jenkins-ci.org/browse/JENKINS-31019[issue JENKINS-31019], to solve that need to upgrade your installation to *v1.640* or newer.
====
